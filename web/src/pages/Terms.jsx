...
export default function Terms() {
  return (
    <div className="relative min-h-screen pt-24 pb-16" style={{ background: 'linear-gradient(180deg, #fefcf3 0%, #f5f1e8 100%)' }}>
      ...
      <p style={{ color: colors.secondaryText }}>By accessing and using Research Locker, you accept and agree to be bound by the terms and provision of this agreement.</p>
      
      <h2 style={{ color: colors.primaryText }}>2. Description of Service</h2>
      <p style={{ color: colors.secondaryText }}>Research Locker is a research paper management application that helps users organize, store, and manage their academic papers and research materials.</p>
      ...
      <p style={{ color: colors.secondaryText }}>Research Locker shall not be liable for any indirect, incidental, special, consequential, or punitive damages.</p>
